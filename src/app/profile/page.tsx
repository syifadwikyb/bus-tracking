...
export default function ProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50/50 pb-10">
            {/* --- HEADER BACKGROUND --- */}
            <div className="h-48 w-full bg-gradient-to-r from-blue-600 to-blue-800 relative overflow-hidden">
            ...
            <div className="px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto -mt-20 relative z-10">
